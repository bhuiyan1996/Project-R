                    ...
                    <div class="col-12">
                        <div class="swiper sliderFeaturedPosts">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <a href="single-post.html" class="img-bg d-flex align-items-end"
                                        style="background-image: url('/frontend/assets/img/post-slide-2.jpg');">
                                        <div class="img-bg-inner">
                                ...
                                <div class="swiper-slide">
                                    <a href="single-post.html" class="img-bg d-flex align-items-end"
                                        style="background-image: url('/frontend/assets/img/post-slide-3.jpg');">
                                        <div class="img-bg-inner">
                                ...
                                <div class="swiper-slide">
                                    <a href="single-post.html" class="img-bg d-flex align-items-end"
                                        style="background-image: url('/frontend/assets/img/post-slide-4.jpg');">
                                        <div class="img-bg-inner">
                ...
                <div class="row g-5">
                    <div class="col-lg-4">
                        <div class="post-entry-1 lg">
                            <a href="single-post.html"><img src="{{url('/frontend/assets/img/post-landscape-1.jpg')}}" alt=""
                                    class="img-fluid"></a>
                            ...
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{url('/frontend/assets/img/person-1.jpg')}}" alt="" class="img-fluid">
                                </div>
                                <div class="name">
                        ...
                        <div class="row g-5">
                            <div class="col-lg-4 border-start custom-border">
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img src="{{url('/frontend/assets/img/post-landscape-2.jpg')}}" alt=""
                                            class="img-fluid"></a>
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img src="{{url('/frontend/assets/img/post-landscape-5.jpg')}}" alt=""
                                            class="img-fluid"></a>
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img src="{{url('/frontend/assets/img/post-landscape-7.jpg')}}" alt=""
                                            class="img-fluid"></a>
                            ...
                            <div class="col-lg-4 border-start custom-border">
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img src="{{url('/frontend/assets/img/post-landscape-3.jpg')}}" alt=""
                                            class="img-fluid"></a>
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img src="{{url('/frontend/assets/img/post-landscape-6.jpg')}}" alt=""
                                            class="img-fluid"></a>
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img src="{{url('/frontend/assets/img/post-landscape-8.jpg')}}" alt=""
                                            class="img-fluid"></a>
                        ...
                        <div class="d-lg-flex post-entry-2">
                            ...
                            <div>
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat
                                    ...
                                    deleniti?</p>
                                <div class="d-flex align-items-center author">
                                    <div class="photo"><img src="{{url('/frontend/assetsimg/person-2.jpg')}}" alt="" class="img-fluid"></div>
                                    <div class="name">
                ...
                <div class="row">
                    <div class="col-md-9 order-md-2">
                        ...
                        <div class="d-lg-flex post-entry-2">
                            ...
                            <div>
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio placeat
                                    ...
                                    deleniti?</p>
                                <div class="d-flex align-items-center author">
                                    <div class="photo"><img src="{{url('/frontend/assets/img/person-4.jpg')}}" alt="" class="img-fluid">
                                    </div>
                                    <div class="name">
                                        <h3 class="m-0 p-0">Wade Warren</h3>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img src="{{('/frontend/assets/img/post-landscape-7.jpg')}}" alt=""
                                            class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Business</span> <span
                                            class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                                    <h2 class="mb-2"><a href="single-post.html">How to Avoid Distraction and Stay
                ...
                <div class="row g-5">
                    <div class="col-lg-4">
                        <div class="post-entry-1 lg">
                            ...
                            <div class="d-flex align-items-center author">
                                <div class="photo"><img src="{{url('/frontend/assets/img/person-7.jpg')}}" alt="" class="img-fluid">
                                </div>
                                <div class="name">
                    ...
                    <div class="col-lg-8">
                        <div class="row g-5">
                            <div class="col-lg-4 border-start custom-border">
                                ...
                                <div class="post-entry-1">
                                    <a href="single-post.html"><img src="{{url('/frontend/assets/img/post-landscape-4.jpg')}}" alt=""
                                            class="img-fluid"></a>
                                    <div class="post-meta"><span class="date">Lifestyle</span> <span
                                            class="mx-1">&bullet;</span> <span>Mar 15th '22</span></div>
                                    <h2><a href="single-post.html">Why Craigslist Tampa Is One of The Most
                        ...
                        <ul class="footer-links footer-blog-entry list-unstyled">
                            <li>
                                <a href="single-post.html" class="d-flex align-items-center">
                                    <img src="{{url('/frontend/assets/img/post-sq-1.jpg')}}" alt="" class="img-fluid me-3">
                                    <div>
                            ...
                            <li>
                                <a href="single-post.html" class="d-flex align-items-center">
                                    <img src="{{url('/frontend/assets/img/post-sq-2.jpg')}}" alt="" class="img-fluid me-3">
                                    <div>
                                        <div class="post-meta d-block"><span class="date">Culture</span> <span
                                                class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                            ...
                            <li>
                                <a href="single-post.html" class="d-flex align-items-center">
                                    <img src="{{url('/frontend/assets/img/post-sq-3.jpg')}}" alt="" class="img-fluid me-3">
                                    <div>
                                        <div class="post-meta d-block"><span class="date">Culture</span> <span
                                                class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
                            ...
                            <li>
                                <a href="single-post.html" class="d-flex align-items-center">
                                    <img src="{{url('/frontend/assets/img/post-sq-4.jpg')}}" alt="" class="img-fluid me-3">
                                    <div>
                                        <div class="post-meta d-block"><span class="date">Culture</span> <span
                                                class="mx-1">&bullet;</span> <span>Jul 5th '22</span></div>
